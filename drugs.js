...
const winterDrugs = [
  ...
  { generic: "Apixaban", brand: ["Eliquis"], class: "Direct oral anticoagulant (DOAC)", indications: ["Atrial fibrillation (stroke prevention)", "Deep vein thrombosis (DVT)", "Pulmonary embolism (PE)", "Thromboembolism prevention"], quiz: "W2" },
  ...
  { generic: "Rivaroxaban", brand: ["Xarelto"], class: "Direct oral anticoagulant (DOAC)", indications: ["Atrial fibrillation (stroke prevention)", "Deep vein thrombosis (DVT)", "Pulmonary embolism (PE)"], quiz: "W2" },
  ...
  { generic: "Fluticasone/salmeterol", brand: ["Advair Diskus", "Advair HFA", "AirDuo RespiClick"], class: "Inhaled corticosteroid and long-acting beta-2 adrenergic agonist combination (ICS/LABA)", indications: ["Asthma", "Chronic obstructive pulmonary disease (COPD)"], quiz: "W6" },
  ...
  { generic: "Methylprednisolone", brand: ["Medrol"], class: "Adrenal corticosteroid", indications: ["Asthma", "Conditions affecting multiple organ systems"], quiz: "W6" },
  ...
  { generic: "Lamotrigine", brand: ["Lamictal"], class: "Anticonvulsant", indications: ["Bipolar disorder", "Seizures"], quiz: "W7" },
