...
const fallDrugs = [
  ...
  { generic: "Amoxicillin/Clavulanate", brand: ["Augmentin"], class: "Beta-lactam antibiotic + Beta-lactamase inhibitor", indications: ["Otitis media", "Sinusitis", "Urinary tract infection (UTI)"], quiz: "F7" },
  ...
  { generic: "Aripiprazole", brand: ["Abilify"], class: "2nd generation (atypical) antipsychotic", indications: ["Bipolar disorder", "Schizophrenia", "Depression", "Tourette syndrome"], quiz: "F10" },
  ...
  { generic: "Clonazepam", brand: ["Klonopin"], class: "Benzodiazepine [C-IV]", indications: ["Panic disorder", "Seizures"], quiz: "F10" },
  { generic: "Diazepam", brand: ["Valium"], class: "Benzodiazepine [C-IV]", indications: ["Alcohol withdrawal syndrome", "Anxiety", "Seizures"], quiz: "F10" },
...
const winterDrugs = [
  ...
  { generic: "Propranolol", brand: ["Inderal", "Inderal LA", "Inderal XL"], class: "Beta-adrenergic blocker, nonselective", indications: ["Hypertension", "Angina", "Cardiac dysrhythmia", "Migraine"], quiz: "W1" },
  ...
  { generic: "Apixaban", brand: ["Eliquis"], class: "Direct oral anticoagulant (DOAC)", indications: ["Atrial fibrillation", "Cerebrovascular accident prevention", "Thromboembolism prevention"], quiz: "W2" },
  { generic: "Dabigatran", brand: ["Pradaxa"], class: "Direct oral anticoagulant (DOAC)", indications: ["Atrial fibrillation", "Cerebrovascular accident prevention"], quiz: "W2" },
  { generic: "Rivaroxaban", brand: ["Xarelto"], class: "Direct oral anticoagulant (DOAC)", indications: ["Atrial fibrillation", "Deep vein thrombosis (DVT)", "Thromboembolism"], quiz: "W2" },
  ...
  { generic: "Topiramate", brand: ["Topamax"], class: "Anticonvulsant", indications: ["Seizures", "Migraine"], quiz: "W7" },
